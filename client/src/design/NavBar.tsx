...
const NavBar: React.FC = () => {
  ...
  return (
    <nav className="md:flex md:justify-between md:items-center p-2 mb-10">
      ...
      <div className={menu ? 'list' : 'md:flex md:items-center z-[-1] md:z-auto md:static  w-full left-0 md:w-auto md:py-0 py-2 md:pl-0 pl-7 md:opacity-100 transition-all ease-in duration-500 opacity-100'}>
        <NavLink to='/play' className="text-3xl my-6 mx-2 block md:my-0 pinky">
          Play
        </NavLink>
        <NavLink to='/createcard' className="text-3xl my-6 mx-2 block pinky md:my-0 whitespace-nowrap">
          Create card
        </NavLink>
        <NavLink to='/leaderboard' className="text-3xl my-6 mx-2 block md:my-0 pinky">
          Leaderboard
        </NavLink>
        <NavLink to='/profile' className="text-5xl my-6 mx-2 block md:my-0 pinky">
      ...
      {!session && (
        <NavLink to='/register' className="text-3xl m-2">
          Play
        </NavLink>
      )}
